...
function AppHourlyForecast({
  ...
  return (
    <section className="relative col-start-2 row-span-3 row-start-1 mt-8 flex h-[685px] flex-col gap-4 rounded-2xl bg-neutral-800 px-4 py-5 xl:mt-0 xl:ml-8 xl:h-[692px] xl:p-6">
